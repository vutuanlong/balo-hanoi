...
<div class="p-top">
	...
	<div class="container l-container">
		<div class="row">
			<div class="col-md-12">
				<div class="filter-tag-product clear clearfix" style="margin-bottom: 20px;">
					<?php
				...
				<div class="filter-tax page-product">
					<?php
					$filters          = rwmb_meta( 'chon_yeu_to_loc', [ 'object_type' => 'term' ], get_queried_object_id() );
					$str              = $filters ? implode( ',', $filters ) : 'product-brand,price-range,pa_color,pa_size';
					$shortcode_filter = '[searchandfilter fields="' . $str . '" submit_label="Xem kết quả"]';
					// echo do_shortcode( $shortcode_filter );
					echo do_shortcode( '[filter_category_product]' );
					?>
